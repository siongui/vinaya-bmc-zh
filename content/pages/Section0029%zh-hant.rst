...
.. list-table::
   ...
   * - *Abbhantara:* a unit for measuring distance, approximately equal to 14 meters.
     - *Abbhantara：* （\ `腕尺 <https://dictionary.sutta.org/browse/a/abbhantara/>`__\ ）一種距離單位，約等於 14 公尺。

   * - *Ācariya:* teacher. See `Chapter 2`_ and `Appendix X`_.
     - *Ācariya：*\ （\ `阿闍梨 <https://dictionary.sutta.org/browse/%C4%81/%C4%81cariya/>`__\ ）老師。參見\ `第二章`_\ 及\ `附錄十`_\ 。

   * - *Acittaka:* a class of offenses carrying a penalty even when committed unintentionally or with incorrect perception.
     - *Acittaka：* （\ `無意識的 <https://dictionary.sutta.org/browse/a/acittaka/>`__\ ）某一種類的罪行，即使是無意或因非正確認知而犯下，也受到懲罰。
